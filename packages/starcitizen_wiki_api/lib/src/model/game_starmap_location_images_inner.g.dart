...
part of 'game_starmap_location_images_inner.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GameStarmapLocationImagesInner _$GameStarmapLocationImagesInnerFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'GameStarmapLocationImagesInner',
  json,
  ($checkedConvert) {
    final val = GameStarmapLocationImagesInner(
...
Map<String, dynamic> _$GameStarmapLocationImagesInnerToJson(
  GameStarmapLocationImagesInner instance,
) => <String, dynamic>{
