...
part 'personal_weapon_spread.g.dart';
...
class PersonalWeaponSpread {
  /// Returns a new [PersonalWeaponSpread] instance.
  ...
  final double? decay;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PersonalWeaponSpread &&
      other.min == min &&
      other.max == max &&
  ...
  factory PersonalWeaponSpread.fromJson(Map<String, dynamic> json) => _$PersonalWeaponSpreadFromJson(json);

  Map<String, dynamic> toJson() => _$PersonalWeaponSpreadToJson(this);
