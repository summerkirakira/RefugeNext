...
class GameVehicle {
  /// Returns a new [GameVehicle] instance.
  GameVehicle({
  ...
  final GameVehicleDimension? dimension;
  ...
  final GameVehicleAgility? agility;
  ...
  final String? link;
      ...
      /// Ship-Matrix vehicle description
  @JsonKey(
  ...
  final String? shipmatrixName;
      ...
      /// Ship-Matrix vehicle foci/roles
  @JsonKey(
  ...
  final List<VehicleSku>? skus;
      ...
      /// Ship-Matrix components (only included when ?include=components)
  @JsonKey(
  ...
  final String? version;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is GameVehicle &&
      other.uuid == uuid &&
      other.name == name &&
    ...
    int get hashCode =>
        ...
        (foci == null ? 0 : foci.hashCode) +
        (productionStatus == null ? 0 : productionStatus.hashCode) +
        (productionNote == null ? 0 : productionNote.hashCode) +
        (type == null ? 0 : type.hashCode) +
        (msrp == null ? 0 : msrp.hashCode) +
        (pledgeUrl == null ? 0 : pledgeUrl.hashCode) +
        (loaner == null ? 0 : loaner.hashCode) +
  ...
  factory GameVehicle.fromJson(Map<String, dynamic> json) => _$GameVehicleFromJson(json);

  Map<String, dynamic> toJson() => _$GameVehicleToJson(this);
