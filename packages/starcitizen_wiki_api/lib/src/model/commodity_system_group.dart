...
part 'commodity_system_group.g.dart';
...
class CommoditySystemGroup {
  /// Returns a new [CommoditySystemGroup] instance.
  ...
  final List<String>? systems;
      ...
      /// All commodity deposit locations within this system.
  @JsonKey(
  ...
  final List<CommodityLinkImagesInner>? images;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CommoditySystemGroup &&
      other.uuid == uuid &&
      other.key == key &&
      other.name == name &&
  ...
  factory CommoditySystemGroup.fromJson(Map<String, dynamic> json) => _$CommoditySystemGroupFromJson(json);

  Map<String, dynamic> toJson() => _$CommoditySystemGroupToJson(this);
