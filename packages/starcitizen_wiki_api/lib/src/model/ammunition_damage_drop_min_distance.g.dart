...
part of 'ammunition_damage_drop_min_distance.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AmmunitionDamageDropMinDistance _$AmmunitionDamageDropMinDistanceFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('AmmunitionDamageDropMinDistance', json, ($checkedConvert) {
  final val = AmmunitionDamageDropMinDistance(
...
Map<String, dynamic> _$AmmunitionDamageDropMinDistanceToJson(
  AmmunitionDamageDropMinDistance instance,
) => <String, dynamic>{
