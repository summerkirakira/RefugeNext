...
part of 'medicine_all_of_container.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MedicineAllOfContainer _$MedicineAllOfContainerFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'MedicineAllOfContainer',
  json,
  ($checkedConvert) {
    final val = MedicineAllOfContainer(
...
Map<String, dynamic> _$MedicineAllOfContainerToJson(
  MedicineAllOfContainer instance,
) => <String, dynamic>{
  'type': ?instance.type,
