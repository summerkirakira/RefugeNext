...
part 'commodity_link_images_inner.g.dart';
...
class CommodityLinkImagesInner {
  /// Returns a new [CommodityLinkImagesInner] instance.
  ...
  final int? originalHeight;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CommodityLinkImagesInner &&
  ...
  factory CommodityLinkImagesInner.fromJson(Map<String, dynamic> json) => _$CommodityLinkImagesInnerFromJson(json);

  Map<String, dynamic> toJson() => _$CommodityLinkImagesInnerToJson(this);
