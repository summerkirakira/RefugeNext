...
part 'vehicle_weapon_charge.g.dart';
...
class VehicleWeaponCharge {
  /// Returns a new [VehicleWeaponCharge] instance.
  VehicleWeaponCharge({
  ...
  final bool? interpolateBonus;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is VehicleWeaponCharge &&
      other.time == time &&
  ...
  factory VehicleWeaponCharge.fromJson(Map<String, dynamic> json) => _$VehicleWeaponChargeFromJson(json);

  Map<String, dynamic> toJson() => _$VehicleWeaponChargeToJson(this);
