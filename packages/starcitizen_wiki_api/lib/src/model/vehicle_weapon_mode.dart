...
part 'vehicle_weapon_mode.g.dart';
...
class VehicleWeaponMode {
  /// Returns a new [VehicleWeaponMode] instance.
  VehicleWeaponMode({
  ...
  final double? rpm;
      ...
      /// Deprecated: Use rpm.
  @Deprecated('roundsPerMinute has been deprecated')
  @JsonKey(
    
    name: r'rounds_per_minute',
    required: false,
    includeIfNull: false,
  )
  ...
  final bool? toggleMode;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is VehicleWeaponMode &&
      other.mode == mode &&
      other.localised == localised &&
      other.type == type &&
      other.rpm == rpm &&
      other.roundsPerMinute == roundsPerMinute &&
    ...
    int get hashCode =>
        ...
        (roundsPerMinute == null ? 0 : roundsPerMinute.hashCode) +
  ...
  factory VehicleWeaponMode.fromJson(Map<String, dynamic> json) => _$VehicleWeaponModeFromJson(json);

  Map<String, dynamic> toJson() => _$VehicleWeaponModeToJson(this);
