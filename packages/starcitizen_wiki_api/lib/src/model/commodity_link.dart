...
class CommodityLink {
  /// Returns a new [CommodityLink] instance.
  CommodityLink({
  ...
  final List<CommodityLinkImagesInner>? images;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CommodityLink &&
      other.uuid == uuid &&
      other.key == key &&
      other.name == name &&
  ...
  factory CommodityLink.fromJson(Map<String, dynamic> json) => _$CommodityLinkFromJson(json);

  Map<String, dynamic> toJson() => _$CommodityLinkToJson(this);
