...
part 'vehicle_weapon_charge_modifier.g.dart';
...
class VehicleWeaponChargeModifier {
  /// Returns a new [VehicleWeaponChargeModifier] instance.
  ...
  final double? heatMultiplier;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is VehicleWeaponChargeModifier &&
      other.damage == damage &&
  ...
  factory VehicleWeaponChargeModifier.fromJson(Map<String, dynamic> json) => _$VehicleWeaponChargeModifierFromJson(json);

  Map<String, dynamic> toJson() => _$VehicleWeaponChargeModifierToJson(this);
