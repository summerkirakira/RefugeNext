...
part of 'commodity_show.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CommodityShow _$CommodityShowFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'CommodityShow',
  json,
  ($checkedConvert) {
    final val = CommodityShow(
      ...
      locations: $checkedConvert(
        ...
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) => CommodityShowLocation.fromJson(e as Map<String, dynamic>),
            )
            .toList(),
      ),
      ...
      systemsGrouped: $checkedConvert(
        'systems_grouped',
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) => CommoditySystemGroup.fromJson(e as Map<String, dynamic>),
            )
            .toList(),
      ),
      rawVersions: $checkedConvert(
        'raw_versions',
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) => CommodityVersionEntry.fromJson(e as Map<String, dynamic>),
            )
            .toList(),
      ),
      blueprints: $checkedConvert(
        ...
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) => CommodityShowAllOfBlueprints.fromJson(
      ...
      items: $checkedConvert(
        ...
        (v) => (v as List<dynamic>?)
            ?.map(
              (e) =>
                  CommodityShowAllOfItems.fromJson(e as Map<String, dynamic>),
            )
            .toList(),
      ),
      uexPrices: $checkedConvert(
        ...
        (v) => v == null
            ? null
            : CommodityShowAllOfUexPrices.fromJson(v as Map<String, dynamic>),
      ),
    );
    return val;
  },
  fieldKeyMap: const {
    ...
    'webUrl': 'web_url',
    'systemsGrouped': 'systems_grouped',
    'rawVersions': 'raw_versions',
    'uexPrices': 'uex_prices',
  },
);

Map<String, dynamic> _$CommodityShowToJson(
  CommodityShow instance,
) => <String, dynamic>{
  'uuid': ?instance.uuid,
  'key': ?instance.key,
  'name': ?instance.name,
  ...
  'systems_grouped': ?instance.systemsGrouped?.map((e) => e.toJson()).toList(),
