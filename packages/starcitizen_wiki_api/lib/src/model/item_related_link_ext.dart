...
part 'item_related_link_ext.g.dart';
...
class ItemRelatedLinkExt {
  /// Returns a new [ItemRelatedLinkExt] instance.
  ItemRelatedLinkExt({
  ...
  final String? class_;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ItemRelatedLinkExt &&
      other.uuid == uuid &&
      other.name == name &&
  ...
  factory ItemRelatedLinkExt.fromJson(Map<String, dynamic> json) => _$ItemRelatedLinkExtFromJson(json);

  Map<String, dynamic> toJson() => _$ItemRelatedLinkExtToJson(this);
