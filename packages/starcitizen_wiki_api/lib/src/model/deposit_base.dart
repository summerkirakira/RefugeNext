...
class DepositBase {
  /// Returns a new [DepositBase] instance.
  DepositBase({
  ...
  final num? relativeProbabilityMaxPercent;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DepositBase &&
      other.key == key &&
      other.label == label &&
  ...
  factory DepositBase.fromJson(Map<String, dynamic> json) => _$DepositBaseFromJson(json);

  Map<String, dynamic> toJson() => _$DepositBaseToJson(this);
