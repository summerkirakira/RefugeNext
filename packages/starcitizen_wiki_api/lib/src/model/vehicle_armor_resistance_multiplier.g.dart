...
part of 'vehicle_armor_resistance_multiplier.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VehicleArmorResistanceMultiplier _$VehicleArmorResistanceMultiplierFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'VehicleArmorResistanceMultiplier',
  json,
  ($checkedConvert) {
    final val = VehicleArmorResistanceMultiplier(
...
Map<String, dynamic> _$VehicleArmorResistanceMultiplierToJson(
  VehicleArmorResistanceMultiplier instance,
) => <String, dynamic>{
