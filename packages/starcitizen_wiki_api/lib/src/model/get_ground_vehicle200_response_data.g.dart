...
part of 'get_ground_vehicle200_response_data.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetGroundVehicle200ResponseData _$GetGroundVehicle200ResponseDataFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'GetGroundVehicle200ResponseData',
  json,
  ($checkedConvert) {
    final val = GetGroundVehicle200ResponseData(
...
Map<String, dynamic> _$GetGroundVehicle200ResponseDataToJson(
  GetGroundVehicle200ResponseData instance,
) => <String, dynamic>{
  'uuid': ?instance.uuid,
  'name': ?instance.name,
