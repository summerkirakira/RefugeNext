...
class BombDamageMap {
  /// Returns a new [BombDamageMap] instance.
  BombDamageMap({
  ...
  final double? stun;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BombDamageMap &&
  ...
  factory BombDamageMap.fromJson(Map<String, dynamic> json) => _$BombDamageMapFromJson(json);

  Map<String, dynamic> toJson() => _$BombDamageMapToJson(this);
