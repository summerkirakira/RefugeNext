# starcitizen_wiki_api.model.CommodityShowLocation
...
------------ | ------------- | ------------- | -------------
**uuid** | **String** | UUID of this starmap location entity. | [optional] 
**key** | **String** | Internal commodity key (e.g. \"Quartz\"). | [optional] 
**name** | **String** | Canonical location name. | [optional] 
**displayName** | **String** | Formatted display name combining designation and name. | [optional] 
...
**designation** | **String** | Location designation code (e.g. \"CRU-L1\"). | [optional] 
**system** | **String** | Star system this location belongs to. | [optional] 
...
**parentUuid** | **String** | UUID of the parent location entity. | [optional] 
**groupProbability** | **num** | Raw probability of this commodity group occurring at this location (0-1). | [optional] 
**groupProbabilityPercent** | **num** | Group probability expressed as a percentage (0-100). | [optional] 
**relativeProbability** | **num** | Raw relative probability compared to other commodities at this location (0-1). | [optional] 
**relativeProbabilityPercent** | **num** | Relative probability expressed as a percentage (0-100). | [optional] 
**qualityMin** | **int** | Minimum quality across all deposit instances at this location. | [optional] 
**qualityMax** | **int** | Maximum quality across all deposit instances at this location. | [optional] 
**areas** | [**List&lt;AreaBoost&gt;**](AreaBoost.md) | Areas with global modifiers that boost spawn rates at this location. | [optional] 
**resources** | [**List&lt;CommodityDepositGroup&gt;**](CommodityDepositGroup.md) | Individual deposit groups for this commodity at this location. | [optional] 
