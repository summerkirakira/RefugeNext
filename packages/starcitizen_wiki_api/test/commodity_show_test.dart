...
// tests for CommodityShow
void main() {
  final CommodityShow? instance = /* CommodityShow(...) */ null;
  ...
  group(CommodityShow, () {
    ...
    // List<CommodityShowLocation> locations
    ...
    // List<CommoditySystemGroup> systemsGrouped
    test('to test the property `systemsGrouped`', () async {
      // TODO
    });

    // Raw (unrefined) versions of this commodity, if this is a refined commodity.
    // List<CommodityVersionEntry> rawVersions
    test('to test the property `rawVersions`', () async {
      // TODO
    });

    // Crafting blueprints that use or produce this commodity.
    // List<CommodityShowAllOfBlueprints> blueprints
    test('to test the property `blueprints`', () async {
      // TODO
    });

    // Physical items associated with this commodity in the game.
    // List<CommodityShowAllOfItems> items
    test('to test the property `items`', () async {
      // TODO
    });

    // CommodityShowAllOfUexPrices uexPrices
