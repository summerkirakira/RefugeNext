...
// tests for GameVehicle
void main() {
  final GameVehicle? instance = /* GameVehicle(...) */ null;
  ...
  group(GameVehicle, () {
    ...
    // GameVehicleDimension dimension
    test('to test the property `dimension`', () async {
      // TODO
    });

    // GameVehicleSizes sizes
    ...
    // GameVehicleSpeed speed
    test('to test the property `speed`', () async {
      // TODO
    });

    // GameVehicleAgility agility
