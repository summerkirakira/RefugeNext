...
// tests for VehicleWeaponMode
void main() {
  final VehicleWeaponMode? instance = /* VehicleWeaponMode(...) */ null;
  // TODO add properties to the entity

  group(VehicleWeaponMode, () {
    // Mode name.
    // String mode
    ...
    test('to test the property `roundsPerMinute`', () async {
      // TODO
    });
