...
// tests for ItemRelatedLinkExt
void main() {
  final ItemRelatedLinkExt? instance = /* ItemRelatedLinkExt(...) */ null;
  // TODO add properties to the entity

  group(ItemRelatedLinkExt, () {
    ...
    // ItemRelatedLinkManufacturer manufacturer
    ...
    // String gradeLabel
    test('to test the property `gradeLabel`', () async {
      // TODO
    });
