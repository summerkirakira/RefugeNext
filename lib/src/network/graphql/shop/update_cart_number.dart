...
class UpdateCartNumber {
  final String query = r"""mutation UpdateCartItemAutomatedUpsellsMutation($skuId: ID!, $qty: Int!, $identifier: String, $storeFront: String) {
  store(name: $storeFront) {
    cart {
      mutations {
        update(skuId: $skuId, qty: $qty, identifier: $identifier)
        __typename
      }
      __typename
    }
...
""";
  ...
  UpdateCartNumber({required this.skuId, required this.qty, required this.identifier});
