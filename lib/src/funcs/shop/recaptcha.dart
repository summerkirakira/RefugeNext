...
class RecaptchaV3 {
  ...
  static Future<String> getSecondStageToken(String firstStageToken) async {
    ...
    final body = response.body;
    final pattern = RegExp(secondStagePattern);
    final match = pattern.firstMatch(body);
    return match?.group(1) ?? "";
  }

  static Future<String> getRecaptchaToken() async {
    final firstStageToken = await getFirstStageToken();
    return await getSecondStageToken(firstStageToken);
  }
}
